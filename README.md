...
Export a full JSON backup before updating. Open the existing Pages address and reload when the update prompt appears. The page must show v6.7.0. Never clear site storage to force an upgrade.
