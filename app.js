...
$('accountSummary').addEventListener('click',e=>{const settled=e.target.closest('[data-settle-pending]'),cancelled=e.target.closest('[data-cancel-pending]'),updated=e.target.closest('[data-update-securities-cash]');if(settled)updateSecuritiesCashFromBank(settled.dataset.settlePending);else if(cancelled)cancelPendingSettlement(cancelled.dataset.cancelPending);else if(updated)updateSecuritiesCashFromBank()});
