...
test('UI script executes with empty state; CSV missing ROI is null',()=>{
 const elems=new Map();const get=id=>{if(!elems.has(id))elems.set(id,{value:id==='perfMarket'?'all':'',addEventListener(){},innerHTML:'',textContent:'',style:{},classList:{add(){},remove(){}},reset(){}});return elems.get(id);};
