/* Stock Ledger 6.10.0: bank cash snapshots and pending-settlement reconciliation. */
const CACHE='stock-ledger-v6-10-0-20260926';
const ASSETS=['./index.html','./ledger.js?v=6.10.0','./app.js?v=6.10.0','./manifest.webmanifest'];
