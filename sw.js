/* Stock Ledger 6.7.0: investment-only capital source tracking. */
const CACHE='stock-ledger-v6-7-0-20260910';
const ASSETS=['./index.html','./ledger.js?v=6.7.0','./app.js?v=6.7.0','./manifest.webmanifest'];
