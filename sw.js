/* Stock Ledger 6.10.1: explicit strategy-budget to bank-cash bridge. */
const CACHE='stock-ledger-v6-10-1-20260926';
const ASSETS=['./index.html','./ledger.js?v=6.10.1','./app.js?v=6.10.1','./manifest.webmanifest'];
