/* Stock Ledger 6.6.1: locked fund policy and refreshed mobile dashboard. */
const CACHE='stock-ledger-v6-6-1-20260910';
const ASSETS=['./index.html','./ledger.js?v=6.6.1','./app.js?v=6.6.1','./manifest.webmanifest'];
