/* Stock Ledger 6.9.1: mixed-source external holdings and net P/L corrections. */
const CACHE='stock-ledger-v6-9-1-20260922';
const ASSETS=['./index.html','./ledger.js?v=6.9.1','./app.js?v=6.9.1','./manifest.webmanifest'];
